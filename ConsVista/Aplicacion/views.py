...
def empleadoLista(request):
	...
	empl3={"documento":"1039481", "nombre":"Maria", "fecha_nacimiento":"01/06/1985", "Sueldo":"500000", "Sexo":"Femenino"}
	empl4={"documento":"1039481", "nombre":"Jose", "fecha_nacimiento":"01/06/0001", "Sueldo":"500000", "Sexo":"Masculino"}
	variable = [empl1, empl2, empl3, empl4]
...
def empleadoModelNuevo(request):
	if request.method=='POST':
	...
	return render_to_response('nuevomodelempleado.html', {'formulario':formulario}, context_instance=RequestContext(request)) 
